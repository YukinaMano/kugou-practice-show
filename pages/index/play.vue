  ...
  <view class="main">
    ...
    <view class="content">
      <view class="content-top">
        <view class="m-singer"
          ><text>{{ nowMusicInfo.mSinger }}</text></view
        >
        <view class="m-effect">
      ...
      <view class="content-bottom">
        ...
        <view class="interactive">
          <text
            v-for="(item, index) in renderPlayItemList"
            :key="index"
            :class="['iconfont', item.name, 'icon']"
          ></text>
        </view>
        <view class="loading">
